...
-   **1 Player (1P)** -- Play against AI.
-   **2 Player (2P)** -- Local multiplayer on the same keyboard.
-   **AI vs AI** -- Watch two bots battle automatically.
...
Loaded via CDN: - **Three.js r128** - **Planck.js 0.3.31**
...
Enjoy playing **Blobby Volley 3D**! 🏐
